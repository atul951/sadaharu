# 🗄️ Trinity College Database Documentation

## Database Overview

The `trinity_college.sqlite` database contains realistic sample data for Trinity College's scheduling system. This SQLite database is pre-populated with core foundational data, providing you with the entities needed to implement the scheduling challenges.
...
```python
import sqlite3
conn = sqlite3.connect('trinity_college.sqlite')
```

```javascript
// Node.js with sqlite3
const sqlite3 = require('sqlite3').verbose();
const db = new sqlite3.Database('trinity_college.sqlite');
```

```java
// Java with JDBC
String url = "jdbc:sqlite:trinity_college.sqlite";
...
*Generated for Trinity College Fullstack Coding Challenge*